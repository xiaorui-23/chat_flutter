...
class _PreviewImageWidgetState extends State<_PreviewImageWidget> {
    ...
    void initState() {
        ...
        if (widget.index != 0) {
            previewImageWidgetPageController = PageController(initialPage: widget.index);
        }
    ...
    Widget build(BuildContext context) {
        return SizedBox(
            ...
            child: PageView.builder(
                ...
                physics: widget.imageList.length > 1 ? const AlwaysScrollableScrollPhysics() : const NeverScrollableScrollPhysics(),
        ...
        showModalBottomSheet(
            ...
            builder: (context) => SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                        for(int index = 0, len = menuList.length; index < len; index++)
                            GestureDetector(
                                onTap: () {
                                    Navigator.pop(context);
